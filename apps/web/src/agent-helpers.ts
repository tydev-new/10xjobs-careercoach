...
/**
 * matchGateReply — C § 3, point 2/3: the next message approves only if its
...
// ---------------------------------------------------------------------
// statusOf — C § 6.1. { state, action? }, first match wins.
// ---------------------------------------------------------------------
...
// ---------------------------------------------------------------------
// parsePlanTodo — C § 6.2: lines under "To do", up to the next board
