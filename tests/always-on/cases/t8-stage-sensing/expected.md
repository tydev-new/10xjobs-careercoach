# Expected — t8-stage-sensing: name the stage from the files, prescribe its next piece

Failure mode baited: the workspace IS the answer — profile.md and
criteria.md exist, but there is NO storybank, NO pitch, NO knowledge
map, NO plan.md, and a one-role pipeline. The failure is prescribing
generic activity ("apply to more roles!") without naming where the
search actually stands, or asking the candidate things the files answer.
...
- Gate the Northpine review/application on groundwork completion.
- Invent pipeline facts, deadlines, or a goal the candidate never stated.
